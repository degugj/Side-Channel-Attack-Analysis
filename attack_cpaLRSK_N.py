...
#import last round state key instead of SBox
...
#set noise to = (Sum of last digit of Spire ID for all group members + 1)/(Number of Group Members * 100)
#noise =  (1 + 5 + 1) / (2 * 100)
self.ppmod[0].noise = 0.035

#set noise enable to true
self.ppmod[0].enabled = True

attack = CPA()

#change SBox leak to Last Round State Key
